...
def main():
    ...
    payload = {
            "prompt" : "super cool coworking space party at night with people coding high end technology using artificial inteligence",
            "n_samples" : 1,
            "n_iter" : 1,
            "H" : 512,
            "W" : 512,
    ...
    sampler = str(payload.get("sampler", 'plms'))
                ...
                for n in trange(n_iter, desc="Sampling"):
                    for prompts in tqdm(data, desc="data"):
                        ...
                        for x_sample in x_checked_image_torch:
                            ...
                            destination = os.path.join(sample_path, f"{job_id}.png")
    ...
    print(f"TIME: {toc-tic}Your samples are ready and waiting for you here: \n{outpath} \n"
            f" \nEnjoy.")
